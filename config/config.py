...
# NVIDIA AI配置
NVIDIA_TIMEOUT = int(os.getenv('NVIDIA_TIMEOUT', '300'))  # 默认3分钟超时
NVIDIA_MAX_RETRIES = int(os.getenv('NVIDIA_MAX_RETRIES', '3'))  # 默认重试3次
...
# 总结模型选择 (支持: deepseek, gemini, hunyuan, zhipu, nvidia)
